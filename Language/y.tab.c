...
{
       0,    37,    37,    40,    41,    42,    46,    49,    52,    65,
      80,    87,   102,   117,   118,   143,   157,   171,   187,   202,
...
{
  "$end", "error", "$undefined", "NAME", "NUMBER", "OPERATOR", "EOL",
  "AP", "FP", "ASSIGN", "SUM", "MIN", "TIMES", "DIV", "IF", "THEN", "ELSE",
  "GT", "LT", "$accept", "PROGRAM", "STATEMENT", "DECLARATION",
  "FUNC_CALL", "FUNC_ASSIGN_VAR", "expr", "condition", "term", "factor", YY_NULLPTR
};
#endif
...
{
       2,    -6,   -14,     6,     2,   -14,   -14,   -14,     0,   -14,
       2,    27,   -14,    26,    41,    26,     5,    47,    34,   -14,
      26,     1,     8,   -14,    52,   -14,    32,     4,   -14,   -14,
      26,    26,    41,    41,    26,   -14,    26,    26,    26,    26,
      28,    28,   -14,   -14,    28,    28,    28,    28,    43,    26,
      28
};
...
{
       0,     0,     6,     0,     2,     4,     5,     7,     0,     1,
       3,    24,    23,     0,     0,     0,    25,     0,    13,    20,
       0,     0,    24,    25,     0,    22,     0,     0,     9,     8,
       0,     0,     0,     0,     0,    21,     0,     0,     0,     0,
      11,    12,    18,    19,    10,    15,    16,    17,     0,     0,
      14
};
...
{
     -14,   -14,    31,   -14,    12,   -14,   -13,   -14,   -14,    -5
};

  /* YYDEFGOTO[NTERM-NUM].  */
static const yytype_int8 yydefgoto[] =
{
      -1,     3,    10,     5,    23,     7,    17,    27,    18,    19
};
...
{
      24,     8,    26,    11,    12,     1,     9,    13,     2,    25,
      34,    14,     6,    28,    15,    20,     6,    40,    41,    39,
      16,    44,     6,    45,    46,    47,    48,    42,    43,    22,
      12,     4,    16,    13,    20,    21,    50,    14,    30,    31,
      15,    36,    30,    31,    22,    12,    32,    33,    13,    37,
      38,     0,    14,    30,    31,    29,     0,    30,    31,    49,
      35,     0,    30,    31
};

static const yytype_int8 yycheck[] =
{
      13,     7,    15,     3,     4,     3,     0,     7,     6,    14,
       9,    11,     0,     8,    14,     7,     4,    30,    31,    15,
       8,    34,    10,    36,    37,    38,    39,    32,    33,     3,
       4,     0,    20,     7,     7,     8,    49,    11,    10,    11,
      14,     9,    10,    11,     3,     4,    12,    13,     7,    17,
      18,    -1,    11,    10,    11,     8,    -1,    10,    11,    16,
       8,    -1,    10,    11
};
...
{
       0,     3,     6,    20,    21,    22,    23,    24,     7,     0,
      21,     3,     4,     7,    11,    14,    23,    25,    27,    28,
       7,     8,     3,    23,    25,    28,    25,    26,     8,     8,
      10,    11,    12,    13,     9,     8,     9,    17,    18,    15,
      25,    25,    28,    28,    25,    25,    25,    25,    25,    16,
      25
};
...
#line 52 "calc.y" /* yacc.c:1646  */
    {
		...
		char fp[2] = ")";
		//strcat(r, ap);
		strcat(r, (yyvsp[-3].str));
		strcat(r, ap);
		strcat(r, (yyvsp[-1].str));
		strcat(r, fp);
		//strcat(r, fp);
		strcpy((yyval.str), r);
		}
...
#line 80 "calc.y" /* yacc.c:1646  */
    { 
		...
		//printFunctions();
		bracket((yyvsp[-5].str), (yyvsp[0].str), "\0");
	}
...
#line 87 "calc.y" /* yacc.c:1646  */
    {
		...
		strcat(r, a);
		strcat(r, ap);
		strcat(r, (yyvsp[-2].str));
		strcat(r, fp);
		strcat(r, ap);
		strcat(r, (yyvsp[0].str));
		strcat(r, fp);
		strcpy((yyval.str), r);
		}
